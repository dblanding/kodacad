...
class MainWindow(QMainWindow):
    ...
    def createEmptyDoc(self):
        ...
        Unfortunately, the names of component parts loaded into this document
        don't show up in tree view. However, if I re-use the xcaf document
        generated by the step reader, the names of the parts *do* show up
        in the tree view. Don't know why."""
    ...
    def createEmptyDoc(self):
        ...
        Todo: Figure out how to set (change) the name of the top assembly."""
        fname = "Top.stp"
