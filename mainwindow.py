...
class MainWindow(QMainWindow):
    ...
    def createEmptyDoc(self):
        ...
        This was to be step 1 of test below, but I wasn't able to get it
        working. Instead, I load a step file containing a top assy with
        one component, then re-use the xcaf doc generated by the step
        reader."""
    ...
    def addComponent(self):
        ...
        This is step 2 in a sequence of steps of a test:
        Step 1 was to import a step file with a top assembly, saving the
